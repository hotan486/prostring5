package com.apress.prospring5.ch3.beanAutowiring.xml.complicated;

import com.apress.prospring5.ch3.beanAutowiring.xml.*;
...
public class CTarget {
	...
	public CTarget(com.apress.prospring5.ch3.beanAutowiring.xml.Foo foo, Bar bar) {
	...
	public static void main(String... args) {
		...
		//primary 사용
		ctx.load("classpath:spring/beanautowiring/app-context-04.xml");
